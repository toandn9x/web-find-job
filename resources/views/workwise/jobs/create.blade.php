                                ...
                                <div class="acc-setting">
                                    ...
                                    <div class="notifications-list">
                                        <div class="notfication-details">
                                            <form action="{{ route('job.store') }}" id="formSubmit" method="POST">
                                                @csrf
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <input type="text" class="form-control enter_ipt" id="lg_title"
                                                            ...
                                                            name="lg_title" data-error="#error_lg_title">
                                                    ...
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <input type="text" class="form-control enter_ipt" id="lg_addr"
                                                            ...
                                                            name="lg_addr" data-error="#error_lg_addr">
                                                    ...
                                                    <div class="form-group col-md-3 mb-4">
                                                        ...
                                                        <select class="custom-select" name="new_money_type"
                                                            id="new_money_type">
                                                            <option selected value="1">Thỏa thuận</option>
                                                            <option value="2">Cố định</option>
                                                            <option value="3">Từ mức - Đến mức</option>
                                                            <option value="4">Trong khoảng</option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group col-md-3 mb-4 wrp_new_money_min">
                                                        <label for="new_money_min" class="mb-3">&nbsp;</label>
                                                        <input type="text" class="form-control" name="new_money_min"
                                                            id="new_money_min" placeholder="Từ mức lương" data-error="#error_lg_money">
                                                    </div>

                                                    <div class="form-group col-md-3 mb-4 wrp_new_money_max">
                                                        <label for="new_money_max" class="mb-3">&nbsp;</label>
                                                        <input type="text" class="form-control" name="new_money_max"
                                                            id="new_money_max" placeholder="Đến mức lượng" data-error="#error_lg_money">
                                                    </div>

                                                    <div class="form-group col-md-6 mb-4 wrp_new_money_kg">
                                                        <label for="new_money_kg" class="mb-3">&nbsp;</label>
                                                        <select class="custom-select" name="new_money_kg"
                                                            id="new_money_kg" disabled>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <textarea name="lg_descirption" id="lg_descirption" data-error="#error_lg_description"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <textarea name="lg_request_other" id="lg_request_other"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <textarea name="lg_benefits_enjoyed" id="lg_benefits_enjoyed" data-error="#error_lg_benefits_enjoyed"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12 mb-4">
                                                        ...
                                                        <textarea name="lg_job_application" id="lg_job_application"></textarea>
                                                    </div>
                                                </div>

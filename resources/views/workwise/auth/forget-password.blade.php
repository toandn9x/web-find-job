                                        ...
                                        <div
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ $message->embed(public_path().'/workwise/images/resources/images/image-5.gif') }}"
                                            ...
                                            <table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 50px;font-family:'Raleway',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #5c5c5c; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 14px; font-weight: 400;">
                                                                Vui lòng hãy đổi mật khẩu khi đăng nhập lại.</h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <strong>Tiêu đề: Khôi phục mật khẩu thành công</strong>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <table height="0px" align="left" border="0"
                                                                cellpadding="0" cellspacing="0" width="38%"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Kính gửi &nbsp;[ {{ $name }} ],
                                                                </p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Mật khẩu của bạn đã được
                                                                    khôi phục trên hệ thống vui lòng thay đổi mật khẩu
                                                                    khi đăng nhập lại hệ thống.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Mật khẩu : <strong>{{ $password }}</strong></p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Nếu bạn gặp vấn đề trong khi sử hệ thống WorkWise xin hãy liên hệ email: <strong>admimxampp@gmail.com</strong> để được hỗ trợ nhiệt tình.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Cảm ơn quý khách đã sử dụng dịch vụ hệ thống WorkWise.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Trân trọng,</p>
                                                                <p style="line-height: 140%;">[ DNDev ]</p>
                                                            </div>
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_image_5" style="font-family:'Raleway',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <p style="font-size: 13px; color:gray; font-style:italic">&copy; 2023 WorkWise. Được phát triển bởi DNDev</p>

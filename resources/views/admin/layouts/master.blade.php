...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <script src="/admins/assets/js/hs.theme-appearance.js"></script>

    <script src="/admins/assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js"></script>
   ...
   {{-- File customize-layout --}}
    @include('admin.includes.customize-layout')
    <!-- End Builder -->
    ...
    <div id="builderOffcanvas" class="position-fixed bottom-0 end-0 me-5 mb-5" style="z-index: 3;"
        ...
        <a class="btn btn-dark btn-lg" href="javascript:;">
            <i class="bi-gear fs-8" id="animate-setting"></i>
        </a>
    </div>
    <!-- End Builder Toggle -->
                ...
                <div class="container">
                    <nav class="js-mega-menu navbar-nav-wrap">
                        ...
                        <a class="navbar-brand" href="index.html" aria-label="Front">
                            ...
                            <img class="navbar-brand-logo" src="/admins/assets/svg/logos-light/logo.svg"
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <img class="avatar avatar-sm avatar-circle"
                                                                                    src="/admins/assets/img/160x160/img3.jpg"
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <img class="avatar-img"
                                                                                        src="/admins/assets/img/160x160/img10.jpg"
                                                                                        alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    class="avatar avatar-sm avatar-circle">
                                                                                    <img class="avatar-img"
                                                                                        src="/admins/assets/svg/brands/google-icon.svg"
                                                                                        alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    class="avatar avatar-sm avatar-circle">
                                                                                    <img class="avatar-img"
                                                                                        src="/admins/assets/img/160x160/img7.jpg"
                                                                                        alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    class="avatar avatar-sm avatar-circle">
                                                                                    <img class="avatar-img"
                                                                                        src="/admins/assets/img/160x160/img5.jpg"
                                                                                        alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    class="avatar avatar-sm avatar-circle">
                                                                                    <img class="avatar-img"
                                                                                        src="/admins/assets/img/160x160/img8.jpg"
                                                                                        alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="card-body card-body-height">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="avatar avatar-xs avatar-4x3"
                                                                    src="/admins/assets/svg/brands/atlassian-icon.svg"
                                                                    alt="Image Description">
                                                            </div>
                                                    ...
                                                    <a class="dropdown-item" href="#">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="avatar avatar-xs avatar-4x3"
                                                                    src="/admins/assets/svg/brands/slack-icon.svg"
                                                                    alt="Image Description">
                                                            </div>
                                                            <div class="flex-grow-1 text-truncate ms-3">
                                                    ...
                                                    <a class="dropdown-item" href="#">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="avatar avatar-xs avatar-4x3"
                                                                    src="/admins/assets/svg/brands/google-webdev-icon.svg"
                                                                    alt="Image Description">
                                                            </div>
                                                            <div class="flex-grow-1 text-truncate ms-3">
                                                    ...
                                                    <a class="dropdown-item" href="#">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="avatar avatar-xs avatar-4x3"
                                                                    src="/admins/assets/svg/brands/frontapp-icon.svg"
                                                                    alt="Image Description">
                                                            </div>
                                                            <div class="flex-grow-1 text-truncate ms-3">
                                                    ...
                                                    <a class="dropdown-item" href="#">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="avatar avatar-xs avatar-4x3"
                                                                    src="/admins/assets/svg/illustrations/review-rating-shield.svg"
                                                                    alt="Image Description">
                                                            </div>
                                                            <div class="flex-grow-1 text-truncate ms-3">
                                    ...
                                    <div class="dropdown">
                                        <a class="navbar-dropdown-account-wrapper" href="javascript:;"
                                            ...
                                            <div class="avatar avatar-sm avatar-circle">
                                                <img class="avatar-img" src="/admins/assets/img/160x160/img6.jpg"
                                                    alt="Image Description">
                                                <span
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account"
                                            ...
                                            <div class="dropdown-item-text">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm avatar-circle">
                                                        <img class="avatar-img"
                                                            src="/admins/assets/img/160x160/img6.jpg"
                                                            alt="Image Description">
                                                    </div>
                ...
                <div class="navbar-dark w-100 bg-dark py-2">
                    <div class="container">
                        <div class="navbar-nav-wrap">
                            <!-- Logo -->
                            <a class="navbar-brand" href="index.html" aria-label="Front">
                                <img class="navbar-brand-logo" src="/admins/assets/svg/logos/logo-white.svg"
                                    alt="Logo">
                            </a>
                            <!-- End Logo -->
    ...
    <script src="/admins/assets/js/demo.js"></script>
        ...
        <div class="offcanvas-body">
            ...
            <ul class="step step-icon-sm step-avatar-sm">
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar" src="/admins/assets/img/160x160/img9.jpg"
                                alt="Image Description">
                        </div>
                                    ...
                                    <div class="row gx-1">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs"
                                                        src="/admins/assets/svg/brands/excel-icon.svg"
                                                        alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs"
                                                        src="/admins/assets/svg/brands/word-icon.svg"
                                                        alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <span class="d-block fs-6 text-dark text-truncate"
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="/admins/assets/img/160x160/img3.jpg"
                                alt="Image Description">
                        </div>
                                    ...
                                    <div class="row gx-1">
                                        <div class="col">
                                            <img class="img-fluid rounded"
                                                src="/admins/assets/svg/components/card-1.svg"
                                                alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="img-fluid rounded"
                                                src="/admins/assets/svg/components/card-2.svg"
                                                alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="img-fluid rounded"
                                                src="/admins/assets/svg/components/card-3.svg"
                                                alt="Image Description">
                                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="/admins/assets/img/160x160/img7.jpg"
                                alt="Image Description">
                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="/admins/assets/img/160x160/img5.jpg"
                                alt="Image Description">
                        </div>
                ...
                <div class="modal-body p-sm-5">
                    <div class="text-center">
                        <div class="w-75 w-sm-50 mx-auto mb-4">
                            <img class="img-fluid" src="/admins/assets/svg/illustrations/oc-collaboration.svg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid" src="/admins/assets/svg/illustrations-light/oc-collaboration.svg"
                ...
                <div class="modal-footer d-block text-center py-sm-5">
                    ...
                    <div class="w-85 mx-auto">
                        <div class="row justify-content-between">
                            <div class="col">
                                <img class="img-fluid" src="/admins/assets/svg/brands/gitlab-gray.svg"
                                    alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="/admins/assets/svg/brands/fitbit-gray.svg"
                                    alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="/admins/assets/svg/brands/flow-xo-gray.svg"
                                    alt="Image Description">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="/admins/assets/svg/brands/layar-gray.svg"
                                    alt="Image Description">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-auto">
                            <a class="d-flex align-items-center small text-body" href="#">
                                <img class="avatar avatar-xss avatar-4x3 me-2"
                                    src="/admins/assets/svg/brands/gmail-icon.svg" alt="Image Description">
                                Import contacts
                            </a>
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled list-py-2 mb-0">
                        ...
                        <li>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img" src="/admins/assets/img/160x160/img3.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img" src="/admins/assets/img/160x160/img9.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
    ...
    <script src="/admins/assets/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
    ...
    <script>
        ...
        HSCore.components.HSDatatables.init($('#datatable'), {
            ...
            language: {
              ...
              <img class="mb-3" src="/admins/assets/svg/illustrations/oc-error.svg" alt="Image Description" style="width: 10rem;" data-hs-theme-appearance="default">
              <img class="mb-3" src="/admins/assets/svg/illustrations-light/oc-error.svg" alt="Image Description" style="width: 10rem;" data-hs-theme-appearance="dark">

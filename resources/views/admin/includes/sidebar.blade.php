                                ...
                                <div class="dropdown dropup">
                                    <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle"
                                        ...
                                        <img class="avatar avatar-xss avatar-circle"
                                            src="/admins/assets/vendor/flag-icon-css/flags/1x1/us.svg"
                                    ...
                                    <div class="dropdown-menu navbar-dropdown-menu-borderless"
                                        ...
                                        <a class="dropdown-item" href="{{ route('change-language', 'vi') }}">
                                            <img class="avatar avatar-xss avatar-circle me-2"
                                                src="/admins/assets/vendor/flag-icon-css/flags/1x1/gb.svg"
                                                alt="Flag">
                                            <span class="text-truncate" title="Việt Nam">Việt Nam</span>
                                        </a>
                                        <a class="dropdown-item" href="#">
                                            <img class="avatar avatar-xss avatar-circle me-2"
                                                src="/admins/assets/vendor/flag-icon-css/flags/1x1/de.svg"
                                                alt="Flag">
                                            <span class="text-truncate" title="Deutsch">Deutsch</span>
                                        </a>
                                        <a class="dropdown-item" href="#">
                                            <img class="avatar avatar-xss avatar-circle me-2"
                                                src="/admins/assets/vendor/flag-icon-css/flags/1x1/dk.svg"
                                                alt="Flag">
                                            <span class="text-truncate" title="Dansk">Dansk</span>
                                        </a>
                                        <a class="dropdown-item" href="#">
                                            <img class="avatar avatar-xss avatar-circle me-2"
                                                src="/admins/assets/vendor/flag-icon-css/flags/1x1/it.svg"
                                                alt="Flag">
                                            <span class="text-truncate" title="Italiano">Italiano</span>
                                        </a>
                                        <a class="dropdown-item" href="#">
                                            <img class="avatar avatar-xss avatar-circle me-2"
                                                src="/admins/assets/vendor/flag-icon-css/flags/1x1/cn.svg"
                                                alt="Flag">
